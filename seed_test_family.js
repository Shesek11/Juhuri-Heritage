...
async function seedTestFamily() {
    ...
    try {
        ...
        const [cohenGrandfather] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, gender, birth_date, birth_place, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?, ?)',
            ['מרדכי', 'כהן', 'male', '1930-03-15', 'דרבנט, דגסטן', false, 1]
        );
        ...
        const [cohenGrandmother] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, maiden_name, gender, birth_date, birth_place, death_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)',
            ['שרה', 'כהן', 'אשורוב', 'female', '1935-07-22', "קובה, אזרבייג'ן", '2020-01-10', false, 1]
        );
        ...
        const [leviGrandfather] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, gender, birth_date, birth_place, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?, ?)',
            ['יעקב', 'לוי', 'male', '1928-11-05', "וורטשן, אזרבייג'ן", false, 1]
        );
        const leviGfId = leviGrandfather.insertId;
        console.log(`  ✅ יעקב לוי (סבא) - ID: ${leviGfId}`);

        const [leviGrandmother] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, maiden_name, gender, birth_date, birth_place, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
            ['רחל', 'לוי', 'נסימוב', 'female', '1932-04-18', "נלצ'יק, רוסיה", true, 1]
        );
        ...
        const [cohenSon1] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, gender, birth_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?)',
            ['דוד', 'כהן', 'male', '1955-02-14', true, 1]
        );
        ...
        const [cohenDaughter1] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, maiden_name, gender, birth_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?, ?)',
            ['מרים', 'לוי', 'כהן', 'female', '1958-08-30', true, 1]
        );
        ...
        const [cohenSon2] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, gender, birth_date, death_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?, ?)',
            ['אברהם', 'כהן', 'male', '1962-12-01', '2015-06-15', false, 1]
        );
        ...
        const [leviSon1] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, gender, birth_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?)',
            ['משה', 'לוי', 'male', '1954-05-12', true, 1]
        );
        ...
        const [leviDaughter1] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, maiden_name, gender, birth_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?, ?)',
            ['אסתר', 'כהן', 'לוי', 'female', '1960-10-08', true, 1]
        );
        ...
        const [firstWife] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, maiden_name, gender, birth_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?, ?)',
            ['דינה', 'כהן', 'יצחקוב', 'female', '1957-03-20', true, 1]
        );
        const dinaId = firstWife.insertId;
        await connection.query(
            'INSERT INTO family_partnerships (person1_id, person2_id, status, start_date, end_date) VALUES (?, ?, ?, ?, ?)',
            [davidCohenId, dinaId, 'divorced', '1978-06-01', '1990-03-15']
        );
        console.log(`  💔 דוד כהן × דינה (גרושים)`);

        // 2. Second wife (current - married אסתר from Levi family!)
        await connection.query(
            'INSERT INTO family_partnerships (person1_id, person2_id, status, start_date) VALUES (?, ?, ?, ?)',
            [davidCohenId, esterId, 'married', '1992-09-10']
        );
        ...
        const [avrahamWife] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, maiden_name, gender, birth_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?, ?)',
            ['לאה', 'כהן', 'שמואלוב', 'female', '1965-07-14', true, 1]
        );
        const leahId = avrahamWife.insertId;
        await connection.query(
            'INSERT INTO family_partnerships (person1_id, person2_id, status, start_date) VALUES (?, ?, ?, ?)',
            [avrahamCohenId, leahId, 'widowed', '1988-11-20']
        );
        ...
        const [child1] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, gender, birth_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?)',
            ['יוסף', 'לוי', 'male', '1982-01-25', true, 1]
        );
        ...
        const [child2] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, gender, birth_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?)',
            ['תמר', 'לוי', 'female', '1985-06-18', true, 1]
        );
        ...
        const [child3] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, gender, birth_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?)',
            ['יצחק', 'כהן', 'male', '1980-09-12', true, 1]
        );
        ...
        const [child4] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, gender, birth_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?)',
            ['נועה', 'כהן', 'female', '1994-12-05', true, 1]
        );
        ...
        const [child5] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, gender, birth_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?)',
            ['אריאל', 'כהן', 'male', '1997-03-22', true, 1]
        );
        ...
        const [child6] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, gender, birth_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?)',
            ['שלמה', 'כהן', 'male', '1990-08-30', true, 1]
        );
        ...
        const [greatGrandchild2] = await connection.query(
            'INSERT INTO family_members (first_name, last_name, gender, birth_date, is_alive, user_id) VALUES (?, ?, ?, ?, ?, ?)',
            ['מיה', 'לוי', 'female', '2013-11-15', true, 1]
        );
