...
const HeroSection: React.FC<HeroSectionProps> = ({ children, dialects = [], showBottomContent = true }) => {
    ...
    return (
        <div className="relative w-full min-h-[40dvh] flex flex-col items-center justify-start pt-24 pb-8 overflow-hidden font-rubik">
            ...
            {/* --- MAIN CONTENT --- */}
            <div className="relative z-20 w-full max-w-full md:max-w-4xl px-5 flex flex-col items-center text-center space-y-6 mt-10 box-border">
            ...
            {showBottomContent && (
                <div className="relative z-20 w-full max-w-full md:max-w-5xl px-5 mt-16 mb-8">
