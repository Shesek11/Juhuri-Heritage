    ...
    <div className="w-full max-w-5xl mx-auto px-4 py-12">
      <div className="bg-[#0d1424]/60 backdrop-blur-xl rounded-2xl shadow-lg p-8 md:p-12 border border-white/10">
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
            אם נתקלתם בבעיית נגישות או שיש לכם הצעות לשיפור, אנא פנו אלינו דרך <Link href="/contact" className="text-amber-600 dark:text-amber-400 hover:underline">עמוד צור קשר</Link>.
          </p>
        </section>
